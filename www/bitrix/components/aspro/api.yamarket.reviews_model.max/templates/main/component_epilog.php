			...
			<div class="module-pagination">
				<div class="nums">
					<ul class="flex-direction-nav">
						...
						<?endif;?>
						<?if(!$arResult["PAGINATION"]["MAX_DISABLED"]):?>
							<li class="flex-nav-next "><a href="javascript:void(0)" data-page="<?=($arResult["CURRENT_PAGE"]+1);?>" title="<?=Loc::getMessage("YM_MAX_PAGE")?>" class="flex-next"></a></li>
						<?endif;?>
					</ul>
