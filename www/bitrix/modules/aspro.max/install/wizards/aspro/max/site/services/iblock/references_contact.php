...
$HL_ID = $_SESSION["MAXIMUM_HBLOCK_CONTACT_ID"];
...
if($HL_ID){
	...
	$arProfits = array(
		"VISA" => array(
			"IMAGE" => "references_files/iblock/c89/6045f271dfc7f55fa8694e6af20d50e6.svg",
			"XML_ID" => "zrtkk8xV",

		),
		"MASTERCARD" => array(
			"IMAGE" => "references_files/iblock/c89/01616f8ba51da0d7ab3a1f1f9d852f9b.svg",
			"XML_ID" => "mc",
		),
		"CACH" => array(
			"IMAGE" => "references_files/iblock/c89/e02d20d83e1adf5d0069dbd4e49db6ec.svg",
			"XML_ID" => "cach",
		),
		"MIR" => array(
			"IMAGE" => "references_files/iblock/c89/c89d03bdcc3177d2f096d41d9a2c3108.svg",
			"XML_ID" => "mir",
		),
	);
	$sort = 100;
