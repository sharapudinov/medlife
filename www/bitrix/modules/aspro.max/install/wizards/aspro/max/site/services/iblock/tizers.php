...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_104").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_4").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_102").'--,--SORT--#--'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["COLORED"].'--#--'.GetMessage("WZD_OPTION_106").'--,--PROPERTY_'.$arProperty["LINK"].'--#--'.GetMessage("WZD_OPTION_108").'--,--PROPERTY_'.$arProperty["SHOW_ON_INDEX_PAGE"].'--#--'.GetMessage("WZD_OPTION_110").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_40").'--;--cedit1--#--'.GetMessage("WZD_OPTION_112").'--,--PROPERTY_'.$arProperty["ICON"].'--#--'.GetMessage("WZD_OPTION_114").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_116").'--;--cedit2--#--'.GetMessage("WZD_OPTION_96").'--,--PROPERTY_'.$arProperty["LINK_REGION"].'--#--'.GetMessage("WZD_OPTION_98").'--;----#--'.GetMessage("WZD_OPTION_10").'--;--',
	));
	// list user options
