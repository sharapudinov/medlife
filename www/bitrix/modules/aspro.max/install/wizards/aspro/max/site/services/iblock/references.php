...
unset($_SESSION["MAXIMUM_HBLOCK_TIZER_ID"]);
unset($_SESSION["MAXIMUM_HBLOCK_CONTACT_ID"]);

$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproMaxContactReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproMaxContactReference', 'TABLE_NAME' => 'b_hlbd_sposobyoplaty');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["MAXIMUM_HBLOCK_CONTACT_ID"] = $HL_ID;
...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproMaxColorReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproMaxColorReference', 'TABLE_NAME' => 'max_color_reference');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["MAXIMUM_HBLOCK_COLOR_ID"] = $HL_ID;
