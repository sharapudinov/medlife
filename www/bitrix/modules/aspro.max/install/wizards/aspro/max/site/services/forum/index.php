...
$arForums = Array(
	Array(
		"XML_ID" => "MAX_REVIEWS",
		"NAME" => GetMessage("MSHOP_REVIEWS_FORUM_NAME"),
		"DESCRIPTION" => GetMessage("MSHOP_REVIEWS_FORUM_DESCRIPTION"),
		"SORT" => 2,
		"ACTIVE" => "Y",
		"ALLOW_HTML" => "N",
		"ALLOW_ANCHOR" => "Y",
...
$reviewsForumID = 0;
$dbRes = CForumNew::GetListEx(array(), array("SITE_ID" => WIZARD_SITE_ID, "XML_ID" => "MAX_REVIEWS"));
if ($arRes = $dbRes->Fetch())$reviewsForumID = $arRes["ID"];
	
	
CWizardUtil::ReplaceMacrosRecursive(WIZARD_SITE_PATH."/catalog/", Array("FORUM_ID" => $reviewsForumID));
