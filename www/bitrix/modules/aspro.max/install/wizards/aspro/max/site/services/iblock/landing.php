...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_118").'--,--ID--#--'.GetMessage("WZD_OPTION_238").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--SORT--#--'.GetMessage("WZD_OPTION_8").'--,--NAME--#--'.GetMessage("WZD_OPTION_4").'--,--CODE--#--'.GetMessage("WZD_OPTION_6").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_102").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_198").'--,--PROPERTY_'.$arProperty["SHOW_ON_INDEX_PAGE"].'--#--'.GetMessage("WZD_OPTION_110").'--,--PROPERTY_'.$arProperty["FORM_QUESTION"].'--#--'.GetMessage("WZD_OPTION_674").'--,--PROPERTY_'.$arProperty["INDEX_TEXT"].'--#--'.GetMessage("WZD_OPTION_682").'--,--PROPERTY_'.$arProperty["SECTION"].'--#--'.GetMessage("WZD_OPTION_676").'--,--PROPERTY_'.$arProperty["FILTER_URL"].'--#--'.GetMessage("WZD_OPTION_684").'--,--PROPERTY_'.$arProperty["COLLECTION_TEMPLATE"].'--#--'.GetMessage("WZD_OPTION_686").'--;--cedit3--#--'.GetMessage("WZD_OPTION_210").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_136").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_176").'--;--cedit4--#--'.GetMessage("WZD_OPTION_212").'--,--PROPERTY_'.$arProperty["PHOTOPOS"].'--#--'.GetMessage("WZD_OPTION_216").'--,--PROPERTY_'.$arProperty["WIDE_TEXT"].'--#--'.GetMessage("WZD_OPTION_214").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_138").'--,--PROPERTY_'.$arProperty["PHOTOS"].'--#--'.GetMessage("WZD_OPTION_140").'--,--PROPERTY_'.$arProperty["H3_GOODS"].'--#--'.GetMessage("WZD_OPTION_688").'--,--PROPERTY_'.$arProperty["SIDE_IMAGE_TYPE"].'--#--'.GetMessage("WZD_OPTION_248").'--,--PROPERTY_'.$arProperty["SIDE_IMAGE"].'--#--'.GetMessage("WZD_OPTION_250").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_132").'--;--cedit1--#--'.GetMessage("WZD_OPTION_12").'--,--PROPERTY_'.$arProperty["BNR_TOP"].'--#--'.GetMessage("WZD_OPTION_178").'--,--PROPERTY_'.$arProperty["BNR_HALF_BLOCK"].'--#--'.GetMessage("WZD_OPTION_234").'--,--PROPERTY_'.$arProperty["BNR_ON_HEADER"].'--#--'.GetMessage("WZD_OPTION_230").'--,--PROPERTY_'.$arProperty["BNR_DARK_MENU_COLOR"].'--#--'.GetMessage("WZD_OPTION_232").'--,--PROPERTY_'.$arProperty["BNR_DOP_TEXT"].'--#--'.GetMessage("WZD_OPTION_38").'--,--PROPERTY_'.$arProperty["ANONS"].'--#--'.GetMessage("WZD_OPTION_690").'--,--PROPERTY_'.$arProperty["CODE_TEXT"].'--#--'.GetMessage("WZD_OPTION_186").'--,--PROPERTY_'.$arProperty["BUTTON_TEXT"].'--#--'.GetMessage("WZD_OPTION_692").'--,--PROPERTY_'.$arProperty["BNR_TOP_IMG"].'--#--'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["BNR_TOP_BG"].'--#--'.GetMessage("WZD_OPTION_180").'--;--cedit2--#--'.GetMessage("WZD_OPTION_96").'--,--PROPERTY_'.$arProperty["LINK_LANDINGS"].'--#--'.GetMessage("WZD_OPTION_266").'--,--PROPERTY_'.$arProperty["LINK_NEWS"].'--#--'.GetMessage("WZD_OPTION_256").'--,--PROPERTY_'.$arProperty["LINK_REVIEWS"].'--#--'.GetMessage("WZD_OPTION_258").'--,--PROPERTY_'.$arProperty["LINK_PARTNERS"].'--#--'.GetMessage("WZD_OPTION_268").'--,--PROPERTY_'.$arProperty["LINK_PROJECTS"].'--#--'.GetMessage("WZD_OPTION_254").'--,--PROPERTY_'.$arProperty["LINK_STAFF"].'--#--'.GetMessage("WZD_OPTION_252").'--,--PROPERTY_'.$arProperty["LINK_BLOG"].'--#--'.GetMessage("WZD_OPTION_270").'--,--PROPERTY_'.$arProperty["LINK_SERVICES"].'--#--'.GetMessage("WZD_OPTION_224").'--,--PROPERTY_'.$arProperty["LINK_BRANDS"].'--#--'.GetMessage("WZD_OPTION_262").'--,--PROPERTY_'.$arProperty["LINK_VACANCY"].'--#--'.GetMessage("WZD_OPTION_264").'--,--PROPERTY_'.$arProperty["LINK_REGION"].'--#--'.GetMessage("WZD_OPTION_98").'--,--PROPERTY_'.$arProperty["LINK_TIZERS"].'--#--'.GetMessage("WZD_OPTION_260").'--;--edit14--#--'.GetMessage("WZD_OPTION_144").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_TITLE--#--'.GetMessage("WZD_OPTION_146").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_KEYWORDS--#--'.GetMessage("WZD_OPTION_148").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_DESCRIPTION--#--'.GetMessage("WZD_OPTION_150").'--,--IPROPERTY_TEMPLATES_ELEMENT_PAGE_TITLE--#--'.GetMessage("WZD_OPTION_152").'--,--IPROPERTY_TEMPLATES_ELEMENTS_PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_154").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_156").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_158").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_160").'--,--IPROPERTY_TEMPLATES_ELEMENTS_DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_162").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_156").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_158").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_160").'--,--SEO_ADDITIONAL--#--'.GetMessage("WZD_OPTION_164").'--,--TAGS--#--'.GetMessage("WZD_OPTION_166").'--;--edit2--#--'.GetMessage("WZD_OPTION_100").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_100").'--;----#--'.GetMessage("WZD_OPTION_10").'--;--',
	));
	// list user options
