...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_770").'--,--ID--#--'.GetMessage("WZD_OPTION_238").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--SORT--#--'.GetMessage("WZD_OPTION_8").'--,--NAME--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["DOCUMENT"].'--#--'.GetMessage("WZD_OPTION_771").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_40").'--;--edit2--#--'.GetMessage("WZD_OPTION_100").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_100").'--;----#--'.GetMessage("WZD_OPTION_10").'--;--',
	));
	// list user options
