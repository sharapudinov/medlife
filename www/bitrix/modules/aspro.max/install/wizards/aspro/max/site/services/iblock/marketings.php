...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_118").'--,--ID--#--ID--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_4").'--,--CODE--#--'.GetMessage("WZD_OPTION_6").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_102").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_672").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_196").'--,--PROPERTY_'.$arProperty["DELAY_SHOW"].'--#--'.GetMessage("WZD_OPTION_780").'--,--PROPERTY_'.$arProperty["LS_TIMEOUT"].'--#--'.GetMessage("WZD_OPTION_781").'--,--PROPERTY_'.$arProperty["FILTER_SHOW"].'--#--'.GetMessage("WZD_OPTION_782").'--;--edit1_csection1--#--'.GetMessage("WZD_OPTION_42").'--,--PROPERTY_'.$arProperty["BTN1_TEXT"].'--#--'.GetMessage("WZD_OPTION_46").'--,--PROPERTY_'.$arProperty["BTN1_LINK"].'--#--'.GetMessage("WZD_OPTION_48").'--,--PROPERTY_'.$arProperty["BTN1_CLASS"].'--#--'.GetMessage("WZD_OPTION_44").'--,--PROPERTY_'.$arProperty["BTN2_TEXT"].'--#--'.GetMessage("WZD_OPTION_52").'--,--PROPERTY_'.$arProperty["BTN2_LINK"].'--#--'.GetMessage("WZD_OPTION_54").'--,--PROPERTY_'.$arProperty["BTN2_CLASS"].'--#--'.GetMessage("WZD_OPTION_50").'--;--cedit2--#--'.GetMessage("WZD_OPTION_40").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_40").'--;--cedit3--#--'.GetMessage("WZD_OPTION_762").'--,--PROPERTY_'.$arProperty["USER_GROUPS"].'--#--'.GetMessage("WZD_OPTION_764").'--,--PROPERTY_'.$arProperty["LINK_REGION"].'--#--'.GetMessage("WZD_OPTION_98").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_100").'--;----#--'.GetMessage("WZD_OPTION_10").'--;--',
	));
