		...
		<div class="text-center g-mb-40 g-mb-60--sm container g-max-width-800">
			...
			>
				...
				<div class="text-center col-lg-3 col-sm-6 g-mb-50 g-mb-0--lg u-countdown--days-hide">
					...
					<span class="landing-block-node-number-text text-uppercase g-color-gray-dark-v1 g-font-weight-700 g-font-size-16">Days</span>
				</div>
				...
				<div class="text-center col-lg-3 col-sm-6 g-mb-50 g-mb-0--lg">
					...
					<span class="landing-block-node-number-text text-uppercase g-color-gray-dark-v1 g-font-weight-700 g-font-size-16">Hours</span>
				</div>
				...
				<div class="text-center col-lg-3 col-sm-6 g-mb-50 g-mb-0--md">
					...
					<span class="landing-block-node-number-text text-uppercase g-color-gray-dark-v1 g-font-weight-700 g-font-size-16">Minutes</span>
				</div>
				...
				<div class="text-center col-lg-3 col-sm-6 g-mb-0">
					...
					<span class="landing-block-node-number-text text-uppercase g-color-gray-dark-v1 g-font-weight-700 g-font-size-16">Seconds</span>
				</div>
