function initAsproMaxCustomFilterControl(params)
{
	var data = JSON.parse(params.data);
	if (data)
	{
		window['aspro_max_customfilter_conditions_' + params.propertyID] = new AsproMaxCustomFilterControl(data, params);
	}
}

function AsproMaxCustomFilterControl(data, params)
{
...
AsproMaxCustomFilterControl.prototype =
{
	getPath: function()
	{
