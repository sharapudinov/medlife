...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SHOW_PRODUCTS_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "21") => "Y",
		"PROPERTY_CODE_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "21") => array(
			0 => "",
			1 => "",
		),
		"CART_PROPERTIES_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "21") => array(
		),
		"ADDITIONAL_PICT_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "21") => "MORE_PHOTO",
		"LABEL_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "21") => "-",
